...
import {saveCustomer, updateCustomer, uploadCustomerProfilePicture, customerProfilePictureURL} from "../../services/client.js";
...
// TODO: make it a componenet later
const MyDropzone = ({customerId, fetchCustomers}) => {
    const onDrop = useCallback(acceptedFiles => {
        ...
        uploadCustomerProfilePicture(
            ...
            successNotification("Success", "Profile picture uplaoded")
            fetchCustomers()
        }).catch((err) => {
            errorNotification("Failed", "Failed profile picture upload")
        })
    }, [])
